...
\begin{itemize}
  ...
  \item \textbf{MLMs offer better sub-context sentence representations.} can have better in-context sentence representation.} Masked Language Models have much better ability to reconcile sentence representations from within a context window, compared to their autoregressive counterparts (\autoref{fig:acceptability}).
