...
A principled focus in computer science research is to develop models which mimic such human-like reasoning. Towards that objective, one of the key goals is to develop models which understand and reason on natural language. Language allows humans to express and comprehend a vast variety of novel thoughts and ideas. It serves as a medium to convey higher-order reasoning and comprehension.
