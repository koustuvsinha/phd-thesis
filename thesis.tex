...
Leveraging the findings from our work, \cite{tamari-etal-2022-dyna} develop a synthetic data generation framework to repurpose the bAbI dataset \citep{weston2015towards}, and find compositional generalization is still a hard problem for Transformer models to solve.
