...
\bottomrule
\end{tabular}}
\caption{Mean (and std) non-parametric probing accuracy on different datasets. $^*$ indicates rebalanced datasets, see \autoref{app:non_par_probes} for more details.}
\label{tab:non_param_comb}
\end{table}
